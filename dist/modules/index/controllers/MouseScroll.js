 ...
 */
define('MouseScroll', ['jquery'], function (require, exports, module) {
  var MouseScroll;
  ...
  MouseScroll = function (options) {
    ...
    var options = Est.extend(defaults, options);

    //cache vars
    var $this = $(options.selector);
    var $scrollerContainer = $this.children(options.container);
    var $scroller = $scrollerContainer.children(options.scroller);
    ...
    if (totalWidth > $this.width() || totalHeight > $this.height()) { //needs scrolling
      ...
      if (options.scrollerType == "hoverAccelerate") { //type hoverAccelerate
        ...
        $this.mousemove(function (e) {
          ...
          var mousePercentY = mouseCoordsY / $this.height();
          if (mousePercentY > 1) {
            mousePercentY = 1;
          }
